    ...
    <div className="grid grid-cols-1  lg:grid-cols-2 lg:grid-flow-row lg:gap-30 gap-9 mb-14 lg:mb-62.5">
      <div className="h-full  aspect-ratio-square">
        ...
        <p className="justify-center items-center text-4 font-[300] ">
          Gym24 is a leading fitness center located near Grushevka metro station, offering over 1500
          sq. m of space dedicated to top-of-the-line workout equipment from leading brands such as
      ...
      <div className="flex flex-shrink-0 flex-grow-0 snap-x overflow-x-auto custom-scrollbar scroll-smooth aspect-ratio-square gap-5">
        <img src={photogym2} className="lg:hidden" alt="" />
        <img src={photogym2} className="lg:w-[570px] lg:h-[454px] mr-auto" alt="" />
        <img src={photogym2} className="lg:hidden" alt="" />
      </div>
    </div>
  );
